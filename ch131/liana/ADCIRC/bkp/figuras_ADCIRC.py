...
# prognóstico_final: até 138 (saídas de 30 em 30 min; não pode ser 144 porque o último horário é 23:30 e não 00:00)
# áreas: bg, sig, ssib
# =====================================================================>
...
if fprog > 138:
	...
	print('Você deve escolher outro valor.    ')
	print('-----------------------------------')
	exit()
...
if sys.argv[1] == "hs":
	...
	for prog in range(0,fprog+1,6): # range de 6 em 6 = range de 3 em 3 horas
		...
		if not os.path.exists(figpath):			
			os.makedirs(figpath) 
		plt.savefig(figpath+'{0}_{1}'.format(figname[sys.argv[1]], '{0:03d}.png'.format(prog)), dpi=300)
		# ~ plt.show()
		plt.close()
